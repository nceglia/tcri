...
VIEW_PACKAGES = ["tools", "plotting", "preprocessing", "diagnostics", "perturbation", "null",
                 "model", "utils", "datasets"]
...
VIEW_NAMESPACES = ["tl", "pl", "pp", "ut", "ml", "diag", "perturb", "null", "datasets", "get"]
