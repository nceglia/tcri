...
# The governance corpus used to live at docs/contract/ and was excluded here by the
# pattern 'contract'. It now lives in governance/ at the repo root, outside the Sphinx
